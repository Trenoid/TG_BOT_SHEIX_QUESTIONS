...
TEXTS = {
    ...
    'en': {
        ...
        'category_selected': 'Topic: <b>{category}</b>\n\nNow send your question in one message. You may attach a photo, document, video, or voice message.',
